...
export default function EventCard({ event }: { event: TEvent }) {
  ...
  return (
    <div className="bg-[#1f1f1f] rounded-xl p-5 h-full min-h-64 flex flex-col border border-gray-800 hover:border-gray-700 transition-colors">
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <h2 className="text-lg line-clamp-1 font-bold text-white">{event.name}</h2>
          <span
